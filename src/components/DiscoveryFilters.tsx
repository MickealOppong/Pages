...
const DiscoveryFilters = () => {
  ...
  const [ageFilter, setAgeFilter] = useState<{ min: string; max: string }>({
    min: url.get("min-age") as string,
    max: url.get("max-age") as string,
  });
  const [genderFilter, setGenderFilter] = useState<string>(
    url.get("gender") as string,
  );
      ...
      <section className="mvp-filters-panel">
        <div className="filters-center">
          ...
          <div className="filters-page-header">
            <h2>
              <FiSliders /> {t("Options.Header.title")}
            </h2>
            <button
              type="button"
              ...
              <div className="filters-grid-engine">
                ...
                <div className="filter-search-group">
                  ...
                  <input
                    ...
                    placeholder={t("Options.Header.any_city")}
                ...
                <div className="filter-input-group">
                  <label>
                    <FiActivity />
                    {t("Options.Header.Shared_activity")}
                  </label>
                  <select
                  ...
                  >
                    ...
                    {MOMENT_OPTIONS.sort((a, b) => {
                      ...
                      return t(`Moments.${keyA}`).localeCompare(
                        t(`Moments.${keyB}`),
                      );
                    }).map((activity) => (
                      <option
                ...
                <div className="filter-input-group">
                  ...
                  >
                    ...
                    <option value="Female">
                      {t("Options.Preference.WOMEN")}
                    </option>
                    <option value="Non-binary">
                      {t("Options.Preference.NON_BINARY")}
                    </option>
                  </select>
                </div>
                {/* Filter 3: gender Selector Dropdown */}
                <div className="filter-input-group">
                  <label>
                    <FiUmbrella /> {t("Options.Header.Looking_for")}
                  </label>
                  <select
